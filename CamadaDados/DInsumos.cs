...
namespace CamadaDados
{
    public class DInsumos
    {
        ...
        public DInsumos(int idInsumo, string nome, string descricao, char feitoComprado, double precoPadrao, double pesoUnitario, int idUnidadeConsumo, int idTipoInsumo)
        {
            IdInsumo = idInsumo;
            Nome = nome;
            Descricao = descricao;
